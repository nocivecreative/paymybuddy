...
### Landing Page 
Home : [/home](http://localhost:8080/home)
...
### Fonctionnel
Transfert de fonds (transaction) : [/transaction](http://localhost:8080/transaction)  
Ajouter une relation (relations) : [/relations](http://localhost:8080/relations)
